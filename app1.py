...
st.caption("I thanks :blue[_Innomatics Reasearch Lab_] to giving me this opportunity ")
st.snow()
...
if btn_click == True:
    st.subheader("Myself Amresh Mishra , My qualification is MBA(IT and marekting) and BCA . \
                 While doing Job in Indiamart(sales) for 1 years I realise that I am not able to giving my 100% to my studies while working \
